...
Route::get('signupAPI','ApiController@signupAPI');
Route::get('profileEditAPI','ApiController@profileEditAPI');
Route::get('loginAPI','ApiController@loginAPI');
Route::get('signInOrUpWithFacebookAPI','ApiController@signInOrUpWithFacebookAPI');
Route::get('signInOrUpWithGoogleAPI','ApiController@signInOrUpWithGoogleAPI');
Route::get('HomeAPI','ApiController@HomeAPI');
Route::get('getCoursesByCategoryAPI','ApiController@getCoursesByCategoryAPI')->name('api');
Route::get('getVideosByCourseAPI','ApiController@getVideosByCourseAPI');
Route::get('addFavouriteAPI','ApiController@addFavouriteAPI');
Route::get('deleteFavouriteAPI','ApiController@deleteFavouriteAPI');
Route::get('favouriteAPI','ApiController@favouriteAPI');
Route::get('searchAPI','ApiController@searchAPI');
Route::get('forgetPasswordAPI','ApiController@forgetPasswordAPI');
Route::get('myCoursesAPI','ApiController@myCoursesAPI');
...
// courses
Route::get('/courses', 'CourseController@getCourses')->name('courses.get');
Route::get('/course', 'CourseController@getSingleCourse')->name('course.get'); //gets a single course with all its content.

//Categories
Route::get('/category/{slug}', 'CourseController@getCategory')->name('category.get'); // retrieves a category and courses for this category.
...
Route::get('/courses/{slug}/learn', 'CourseController@show')->name('course.show')->middleware('affiliateCookie');
...
//////////////  \\\\\\\\\\\\\
//////     EditPRof    \\\\\\\
// Route::get('/profile/edit', 'ProfileController@showEditProf')->name('profile.edit');
/////////////   \\\\\\\\\\\\\\\
...
Route::group(['middleware' => 'auth'], function () {
    Route::group(['namespace' => 'User', 'as' => 'user.'], function () {
        ...
        // bookmark courses
        Route::post('/courses/{course}/create-bookmark', 'CourseController@bookmark')->name('create-bookmark');
        Route::get('/courses/{course}/get-wishlist-status', 'CourseController@getBookmarkStatus');
        Route::delete('/courses/{course}/delete-bookmark', 'CourseController@unbookmark')->name('delete-bookmark');
