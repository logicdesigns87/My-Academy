        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                @if (config('locale.status') && count(config('locale.languages')) > 1)
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            <img src="{{asset('/images/flags/'.app()->getLocale().'.svg')}}" style="width:25px;"/> {{ trans('menus.language-picker.language') }} <span class="caret"></span>
                        </a>
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('img1/testimonials/'.access()->user()->avatar) }}" class="user-image" alt="User Avatar"/>
                        <span class="hidden-xs">{{ access()->user()->full_name }}</span>
                    </a>

                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="{{ asset('img1/testimonials/'.access()->user()->avatar) }}" class="img-circle" alt="User Avatar" />
                            <p>
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{!! route('frontend.index') !!}" class="btn btn-default btn-flat" target="_blank">
