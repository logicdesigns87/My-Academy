        ...
        <div class="bg-stripe-overlay">
            <div class="container">
                <div class="row top-row">
                    <div class="col-md-6">
                        <video autoplay loop muted id="background" style="" poster="/work/myacademy/beta1/public/images/background-homepage.jpg">
                            <source src="/work/myacademy/beta1/public/images/background-homepage.mp4" type="video/mp4">
                        </video>
                    </div>
                    <div class="col-md-6">
